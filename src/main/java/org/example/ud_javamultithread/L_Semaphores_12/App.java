package org.example.ud_javamultithread.L_Semaphores_12;
...
public class App {
    public static void main(String[] args) throws Exception {
        Semaphore s1 = new Semaphore(1);
                System.out.println("Available permits: "+s1.availablePermits());
                s1.release();  // increment the number of permits
                System.out.println("Available permits: "+s1.availablePermits()); // 2
                s1.acquire();  // decrement the number of permits
                System.out.println("Available permits: "+s1.availablePermits()); //1
                s1.acquire();  // decrement the number of permits
                System.out.println("Available permits: "+s1.availablePermits()); //0
               // s1.acquire();  // decrement the number of permits              ! blocking no permits available
               // System.out.println("Available permits: "+s1.availablePermits());
