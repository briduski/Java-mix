package org.example.ud_javamultithread.H_WaitAndNotify;
...
public class Processor {
    ...
    public void produce() throws InterruptedException {
        synchronized (this) {
            ...
            wait();//this.wait() is fine.   At this point the synchronized block will loose ctrl of the lock
            System.out.println("[Producer] Resumed. (a notify was done on the same lock)");
        }
    }
    ...
    public void consume() throws InterruptedException {
        ...
        synchronized (this) {
            ...
            notify(); // this is no enough to releash he lock, it mus be finished' the synchronized the block
            Thread.sleep(5000);
            System.out.println("[Consumer] Consumption done.");
        }
    }
}